      ...
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        ...
        <div className="flex justify-start item-start space-y-2 flex-col">
          ...
          <p className="text-base dark:text-gray-300 font-medium leading-6 text-gray-600">
            {convertedDateTime.format("YYYY-MM-DD HH:mm:ss")}
          </p>
        </div>
                    ...
                    <div className="flex justify-between space-x-8 items-start w-full">
                      <p>
                        <span className="text-1xl font-bold text-red-500">
                          {item.bookId.discount.toLocaleString("vi-VN")}đ
                        </span>
                        <span className="text-sm text-slate-900 line-through">
                          {item.bookId.sale > 0
                            ? item.bookId.price.toLocaleString("vi-VN") + "đ"
                            : ""}
                        </span>
                      </p>
                      <p className="text-sm dark:text-white xl:text-md leading-6 text-gray-800">
                        {item.quantity}
                      </p>
                      <p className="text-sm dark:text-white xl:text-md font-semibold leading-6 text-gray-800">
                        $
                        {(item.quantity * item.bookId.discount).toLocaleString(
                          "vi-VN"
                        )}
                        ₫
                      </p>
